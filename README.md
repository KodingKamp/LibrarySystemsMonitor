...
This project is a stripped-down verison of an application I built at work and primarily works in browsers that are updated to be compatible with HTML5 and CSS3.
<h2>Description</h2>
